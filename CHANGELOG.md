...
## [1.2.1] - 2023-08-31
### Breaking Changes
- Changed the wallet factory address so the smart wallet address will generate a new address0x4B53Fa863df089cEF60C3F39f95811718DAe451b. Whoever wishes to access the old wallet should use version 1.2.0 to connect to the old smart wallet
