...
export interface TestEtherspotWalletInterface extends utils.Interface {
  functions: {
...
export interface TestEtherspotWallet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestEtherspotWalletInterface;
