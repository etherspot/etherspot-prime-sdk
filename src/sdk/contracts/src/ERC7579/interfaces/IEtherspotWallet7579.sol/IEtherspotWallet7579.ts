...
export interface IEtherspotWallet7579Interface extends utils.Interface {
  functions: {
...
export interface IEtherspotWallet7579 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IEtherspotWallet7579Interface;
